...
const USER_SERVICE_UUID = "93125dca-7ad1-4af8-a960-bc52bf587680";
...
function liffGetUserService(service) {
  ...
  service
    .getCharacteristic(SCORE_CHARACTERISTIC_UUID)
    .then(characteristic => {
...
function liffWriteScore(sendScore) {
  if (sendScore < 100) {
    window.scoreCharacteristic
      .writeValue(new Uint8Array([sendScore]))
      .catch(error => {});
  }
}
